...
{
    public class ProvincialAwardExpertInfoArrangeViewModel : ViewModelBase
    {
        #region 变量

        private string oldFilePath;
        private string newFilePath;
        private ExpertDictionary dic = null;

        #endregion 变量

        #region 构造函数

        public ProvincialAwardExpertInfoArrangeViewModel()
        {
            Init();
        }
        ...
        {
            dic = new ExpertDictionary();
            ExpertExcelHelper.ReadExpertInfo(OldFilePath, dic);
        }
